package com.michelin.suricate.widget.tester.services.nashorn.script;
...
import com.michelin.suricate.widget.tester.utils.exceptions.nashorn.RequestException;
...
class NashornWidgetScriptTest {
    ...
    void shouldBtoaEmpty() {
        String actual = NashornWidgetScript.btoa(EMPTY);
        assertThat(actual).isNull();
    }
